...
It means it is missing data so the mean cannot be calculated. This means that NAs are not interpreted as a number, it is just seen as a absent piece of data.
